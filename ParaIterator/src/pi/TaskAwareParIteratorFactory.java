 ...
 * @author Lama Akeila
 * Adjustments by: Anneke Smitheram
 */
public class TaskAwareParIteratorFactory<E> {
	
	private TaskAwareParIteratorFactory() {}
	 ...
	 */
	public static<E> ParIterator<E> createParIterator(Collection<E> collection, int threadCount, int taskCount, ParIterator.Schedule schedulePol, int chunksize, boolean ignoreBarrier) {
		return getIterator(collection, schedulePol, chunksize, threadCount, taskCount, ignoreBarrier);
	}
	 ...
	 * @return				An instance of <code>ParIterator</code>.
	 */
	public static<E> ParIterator<E> createParIterator(Collection<E> collection, int threadCount, int taskCount, ParIterator.Schedule schedulePol, int chunksize) {
		return getIterator(collection, schedulePol, chunksize, threadCount, taskCount, false);
	}
	 ...
	 * @return				An instance of <code>ParIterator</code>.
	 */
	public static<E> ParIterator<E> createParIterator(Collection<E> collection, int threadCount, int taskCount) {
		return getIterator(collection, ParIterator.Schedule.DYNAMIC, ParIterator.DEFAULT_CHUNKSIZE, threadCount, taskCount, false);
	}
	 ...
	 * @return				An instance of <code>ParIterator</code>.
	 */
	public static<E> ParIterator<E> createParIterator(Collection<E> collection, int threadCount, int taskCount, ParIterator.Schedule schedulePol) {
		return getIterator(collection, schedulePol, ParIterator.DEFAULT_CHUNKSIZE, threadCount, taskCount, false);
	}
	 ...
	 * @return				An instance of <code>ParIterator</code>.
	 */
	public static<E> ParIterator<E> createParIterator(E[] collection, int threadCount, int taskCount, ParIterator.Schedule schedulePol, int chunksize, boolean ignoreBarrier) {
		return getIterator(Arrays.asList(collection), schedulePol, chunksize, threadCount, taskCount, ignoreBarrier);
	}
	 ...
	 * @return				An instance of <code>ParIterator</code>.
	 */
	public static ParIterator<Integer> createParIterator(int start, int size, int increment, int threadCount, int taskCount, ParIterator.Schedule schedulePol, int chunksize, boolean ignoreBarrier) {
...
//		}
		return getIterator(nums, schedulePol, chunksize, threadCount, taskCount, ignoreBarrier);
	}
	 ...
	 */
	private static<E> ParIterator<E> getIterator(Collection<E> collection, ParIterator.Schedule schedulePol, int chunksize, int threadCount, int taskCount, boolean ignoreBarrier) {
		switch (schedulePol) {
			case STATIC:
			...
			case TASKAWARE:
				return new TaskAwareDynamicParIterator<E>(collection, chunksize, threadCount, taskCount, ignoreBarrier);
			default:
